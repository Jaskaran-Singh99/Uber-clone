...
const WaitingForADriver = (props) => {
  ...
  >
    ...
    <div  className='flex flex-col justify-between items-center mb-5'>
        <img className="h-44  justify-center" src="https://thumbs.dreamstime.com/b/taxi-driver-man-car-cab-vector-illustration-flat-style-taxi-driver-man-car-cab-vector-illustration-114972324.jpg"></img>
        {/* <div>
      ...
      <div>
        <h3 className="italic text-5xl text-center">"{props.ride?.otp}"</h3>
